...
const testimonials = [
  {
    tempId: 0,
    testimonial: "My digestion improved in days — I feel lighter and more energetic.",
    by: "Thandi, Durban",
    imgSrc: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face"
  },
  {
    tempId: 1,
    testimonial: "I finally feel balanced again. This stuff works.",
    by: "Lindiwe, Cape Town",
    imgSrc: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"
  },
  {
    tempId: 2,
    testimonial: "Pure, natural, and effective — it's now part of my daily routine.",
    by: "Marius, Johannesburg",
  ...
  {
    tempId: 4,
    testimonial: "The natural ingredients make me feel confident about what I'm putting in my body.",
    by: "David, Durban",
  ...
  {
    tempId: 6,
    testimonial: "I love that it's made with organic honey — nature's perfect delivery system!",
    by: "James, Johannesburg",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter
          ? "z-10 bg-[#81c8bf] text-white border-[#81c8bf]"
          : "z-0 bg-white text-card-foreground border-border hover:border-[#81c8bf]/50"
      )}
      style={{
        width: cardSize,
        height: cardSize,
      ...
      <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2">
        <button
          ...
          className={cn(
            ...
            "bg-background border-2 border-border hover:bg-[#81c8bf] hover:text-white",
