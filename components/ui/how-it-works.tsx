...
export function HowItWorks() {
  ...
  const features = [
    ...
    },
    {
      ...
      image: "/images/bottles/bottle-j.png",
    },
    {
      id: 3,
      icon: "03",
    ...
    },
    {
      ...
      image: "/images/bottles/Bottle-Hands.png",
    },
  ];
  ...
  return (
    <div ref={sectionRef} className="min-h-screen py-16 px-4 bg-[#f9f9f9]">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    `}
                    >
                      <div className="text-4xl font-medium text-[#8bccc2]">
                        {feature.icon}
                      </div>
                    </div>
