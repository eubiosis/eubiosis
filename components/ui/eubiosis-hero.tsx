  ...
  return (
    <>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20 -mt-20">
          ...
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="text-left relative">
              ...
              <div className="mb-12 mt-8">
                ...
                <div className="mt-6 w-16 sm:w-20 h-px bg-gradient-to-r from-white/50 via-white/70 to-transparent opacity-60"></div>
              </div>
              ...
              <div className="mb-8">
                <p className="text-lg sm:text-xl text-white/70 max-w-2xl leading-relaxed">
                  <span className="word-animate" data-delay="2400">Premium</span>{' '}
                  <span className="word-animate" data-delay="2600">honey-based</span>{' '}
                  <span className="word-animate" data-delay="2800">probiotic</span>{' '}
                  <span className="word-animate" data-delay="3000">with</span>{' '}
                  <span className="word-animate" data-delay="3200">42</span>{' '}
                  <span className="word-animate" data-delay="3400">bacterial</span>{' '}
                  <span className="word-animate" data-delay="3600">strains</span>
                </p>
              </div>
              ...
              <div className="text-left">
                <div className="mb-4 w-12 sm:w-16 h-px bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-30"></div>
                <h2 className="text-xs sm:text-sm font-mono font-light text-white/80 uppercase tracking-[0.2em] opacity-80">
                ...
                <div className="mt-6 flex justify-start space-x-4 opacity-0" style={{ animation: 'word-appear 1s ease-out forwards', animationDelay: '4.8s' }}>
                  <div className="w-1 h-1 bg-white/40 rounded-full opacity-40"></div>
                  <div className="w-1 h-1 rounded-full opacity-60" style={{ backgroundColor: '#8dcdc6' }}></div>
                  <div className="w-1 h-1 bg-white/40 rounded-full opacity-40"></div>
                </div>
              </div>
              ...
              <div className="mt-8 w-full">
                <div className="flex flex-col sm:flex-row gap-4 items-start opacity-0" style={{ animation: 'word-appear 1s ease-out forwards', animationDelay: '5.4s' }}>
                  <a href="/eubiosis-bottle/size-s/quantity-1" className="btn">
                    Shop Now
                  </a>
