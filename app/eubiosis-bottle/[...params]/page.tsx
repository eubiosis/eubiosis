          ...
          <div className="grid md:grid-cols-2 gap-8 items-start pt-1">
            ...
            >
              ...
              <div className="flex justify-center">
                <motion.div 
                  className={`w-full max-w-md h-[500px] rounded-eubiosis overflow-hidden cursor-zoom-in transition-all duration-300 ${
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      disabled={quantity <= 1}
                      className="w-8 h-8 rounded-full bg-white/60 backdrop-blur-sm border border-white/40 flex items-center justify-center hover:bg-white/80 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-white/60 backdrop-blur-sm border border-white/40 flex items-center justify-center hover:bg-white/80 transition-all"
                    >
